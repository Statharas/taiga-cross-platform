...
| Now Playing | Present as a real v1-style detail page with poster, current episode text, action links, alternative titles, details, and synopsis, plus the bottom toggle widget used by the View menu. |
| Anime List | Present as a table-first page with v1-style status tabs and list/search filtering. |
...
| Torrents | Present: v1 torrent columns, checkable rows, feed refresh, marked download/open, discard marked/all, filter box, and settings shortcut. |
...
- `taiga-main-ui-parity-tests` checks the main menu, page count, and sidebar
  inventory against the v1 shell.
